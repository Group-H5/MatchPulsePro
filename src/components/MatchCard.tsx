...
export default function MatchCard({ match }: MatchCardProps) {
  ...
  return (
    <Link
      ...
      className="group hover:border-brand-pulse/70 relative block overflow-hidden rounded-[2rem] border border-white/10 bg-white/5 p-6 backdrop-blur-md transition duration-300 hover:-translate-y-1"
    >
      ...
      <div className="relative flex items-start justify-between gap-4">
        <div>
          <p className="text-xs font-black tracking-[0.28em] text-gray-500 uppercase">
            {match.status}
          </p>
        ...
        <div className="rounded-full border border-white/10 px-3 py-1 text-xs font-black text-white/80">
      ...
      <div className="relative mt-8">
        <div className="mb-2 flex items-center justify-between text-xs font-bold tracking-[0.25em] text-gray-500 uppercase">
      ...
      <p className="relative mt-5 text-sm leading-6 text-gray-400">
        {match.topPlayer
